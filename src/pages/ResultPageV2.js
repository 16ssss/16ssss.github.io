    ...
    <>
      ...
      >
        ...
        >
          ...
          <img
            src={
              process.env.PUBLIC_URL + `/characters/${result.toLowerCase()}.png`
            }
        ...
        <Grid2 xs={12}>
          <ResultProgressBar
            value={rate[0] > 50 ? rate[0] : 100 - rate[0]}
            type={rate[0] > 50 ? 'left' : 'right'}
            left='E'
            right='I'
          />
          <br />
          <ResultProgressBar
            value={rate[1] > 50 ? rate[1] : 100 - rate[1]}
            type={rate[1] > 50 ? 'left' : 'right'}
            left='S'
            right='N'
          />
          <br />
          <ResultProgressBar
            value={rate[2] > 50 ? rate[2] : 100 - rate[2]}
            type={rate[2] > 50 ? 'left' : 'right'}
            left='T'
            right='F'
          />
          <br />
          <ResultProgressBar
            value={rate[3] > 50 ? rate[3] : 100 - rate[3]}
            type={rate[3] > 50 ? 'left' : 'right'}
            left='J'
            right='P'
          />
        </Grid2>
